...
public class SpriteSheet {
	...
	/**
	 * initializes a new SpriteSheet by assigning the image located at the path to
	 * the BufferedImage and removing any instance of the hexes FF00FF and 7F007F,
	 * replacing them with transparent pixels
	 * 
	...
	public SpriteSheet(String path) {
		...
		if (path.contains(":"))
			imageBuffer = Loader.loadImageFromFile(path);
		else
	...
	/**
	 * returns a sub-image from the SpriteSheet with the top left corner located at
	 * (x, y), with a height and width of size
	 * 
	...
	/**
	 * returns a sub-image from the SpriteSheet with the top left corner located at
	 * (x, y), with a height and width determined by parameters
	 * 
	 * @param x      - the x value (in pixels) of the top left corner of the
	 *               sub-image
	 * @param y      - the y value (in pixels) of the top left corner of the
	 *               sub-image
	...
	/**
	 * returns a reflection of the buffered image input with the top left corner
	 * reflected to the top right
	 * 
